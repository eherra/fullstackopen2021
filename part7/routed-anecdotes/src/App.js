...
const Notification = ({notificationText}) => {
    return (
      <div>
        { notificationText && <p>{notificationText}</p>}
      </div>
    )
}
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button>create</button><button onClick={e => handleReset(e)}>reset</button>
      </form>
    </div>
  )
}
...
const App = () => {
  ...
  const addNew = (anecdote) => {
    ...
    handleNotificationShow(`a new anecdote ${anecdote.content} created!`)
