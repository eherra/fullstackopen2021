...
describe('favorite blog', () => {
  test('when list has 6 blogs, favorite blog is from Edsger W. Dijkstra', () => {
    const result = listHelper.favoriteBlog(listWithSixBlogs)
    const expetedFavBlog = 
      {
        title: "Canonical string reduction",
        author: "Edsger W. Dijkstra",
        likes: 12
      }
    expect(result).toEqual(expetedFavBlog)
  })
})

describe('most blog', () => {
  test('when list has 6 blogs, most blogs has Robert C. Martin', () => {
...
describe('most likes', () => {
  test('when list has 6 blogs, most likes has Edsger W. Dijkstra', () => {
